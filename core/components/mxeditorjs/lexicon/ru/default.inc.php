...
$_lang['setting_mxeditorjs.available_tools_desc'] = 'Список всех блочных инструментов через запятую. Используется в «tools» профилей или в mxeditorjs.enabled_tools.';
